...
export class SpeechController {
    ...
    @ApiBody({ schema: { type: "object", properties: { text: { type: "string" }, voice: { type: "string", enum: ["alloy", "verse", "aria", "sage", "coral"] }, format: { type: "string", enum: ["mp3", "wav", "opus", "aac", "flac", "pcm"] }, language: { type: "string", enum: ["en", "ar"] } } } })
